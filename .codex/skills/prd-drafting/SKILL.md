...
새 표준 진입점은 `$do-next`다. Codex에서 PRD/ADR 확정까지 진행할 때는 먼저
`.codex/skills/do-next/SKILL.md`와 `docs/harness/protocols/do-next.md`를 따른다.
이 어댑터는 `$do-next` 내부 PRD 작성 단계 또는 레거시 호환 요청에서만 사용한다.

공용 기준:

1. `docs/harness/protocols/prd-drafting.md`
2. `docs/harness/roles/prd-writer.md`
