...
새 표준 진입점은 `$do-next`다. ClaudeCode에서 새 열린 요청을 받으면 먼저
`.claude/skills/do-next/SKILL.md`와 `docs/harness/protocols/do-next.md`를 따른다.
이 어댑터는 `$do-next` 내부 후보 발굴 단계 또는 레거시 호환 요청에서만 사용한다.

호환 사용 순서:

1. `docs/harness/protocols/work-intake.md`
2. `docs/harness/roles/intake-helper.md`
3. `docs/harness/roles/unit-planner.md`
