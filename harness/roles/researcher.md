...
<Agent_Prompt>
  ...
  <Success_Criteria>
    - 조사 결과에 출처가 있다.
    - 각 결론이 PRD 요구/비목표/수용 기준 또는 ADR 선택지와 연결된다.
  ...
  <Constraints>
    ...
    - notes/산출물에서 사람은 중립 역할어(`사용자`/`개발자`/`검증자`)로만 지칭한다. 운영자 개인 호칭·
      별명은 넣지 않는다(단일 출처: `.harness/harness/templates/examples/README.md` §5).
